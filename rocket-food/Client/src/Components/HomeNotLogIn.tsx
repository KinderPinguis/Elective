        ...
        <div className="Home">
                ...
                <Row gutter={[88, 8]} style={{ marginTop: '190px' }}>
                    <Col flex="1" style={{ textAlign: 'center' }}>
                        <Col>
                            ...
                            <p>ordering food in Rocket Food</p>
                        </Col>
                    </Col>
                    <Col flex="1" style={{ textAlign: 'center' }}>
                        <Col>
                            ...
                            <p>even faster in Rocket Food</p>
                        </Col>
                    </Col>
                    <Col flex="1" style={{ textAlign: 'center' }}>
                        <Col>
            ...
            <Row wrap={true} justify={'center'}>
                ...
                <Col style={{marginLeft:'40px'}}>
                    ...
                    <p>Rocket food is an upfront for Delivery services<br/>I am amazed every time i use this app<br/>I am always confident while using the application<br/>We need more as Rocket Food</p>
                    <Review
